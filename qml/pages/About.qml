...
Page {
    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Image {
                source: "/usr/share/icons/hicolor/172x172/apps/Septitrac.png"
            ...
            Text {
                text: "Github: <a href=\"https://github.com/Michal-Szczepaniak/septitrac\">github.com/Michal-Szczepaniak/septitrac</a>"
                color: "white"
            ...
            Label {
                text: qsTr("Fernando Lanero for being awesome testers.")
                horizontalAlignment: Text.AlignHCenter
                font.pixelSize: Theme.fontSizeSmall
            ...
            Label {
                text: qsTr("Fernando Lanero for spanish translation.")
                font.pixelSize: Theme.fontSizeSmall
                anchors.horizontalCenter: parent.horizontalCenter
            }
